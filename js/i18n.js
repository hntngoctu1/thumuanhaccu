...
(function () {
  ...
  var DICT = {
    ...
    "Niềm tin từ người bán": "Trusted by sellers",
    '"Mình bán cây Yamaha U3, được giá tốt hơn nơi khác, nhận tiền ngay trong ngày. Anh kỹ thuật tới tận nhà rất đúng giờ."': '"I sold my Yamaha U3 for a better price than elsewhere and got paid the same day. The technician came to my home right on time."',
    '"Thanh lý nguyên dàn âm thanh quán cà phê, định giá nhanh, vận chuyển khỏi lo. Rất chuyên nghiệp và uy tín."': '"I cleared the whole sound system from my café — fast valuation, no transport hassle. Very professional and trustworthy."',
    '"Cây organ cũ để lâu tưởng bỏ đi, gọi Cô Linh được thu mua với giá bất ngờ. Cảm ơn trung tâm rất nhiều!"': '"My old organ sat unused for years and I thought it was junk — I called Ms. Linh and got a surprising price. Thank you so much!"',
    "Chị Hương": "Ms. Huong",
    "Quận 7, TP.HCM": "District 7, HCMC",
    "Anh Tuấn": "Mr. Tuan",
